            ...
            <div class="flex items-center justify-center bg-gray-100">
                <div
                    ...
                    <div class="flex items-center mb-2 space-x-4">
                        <img class="w-10 ml-2 rounded-full" src="{{ asset('tony.png') }}" alt="Tony Pizza" />
                        <div>
                            <h1 class="mb-1 text-xl font-bold text-gray-700">Tony Pizza</h1>
                            <p class="text-sm font-normal text-gray-600 mr-14 hover:underline">#Livewire ~2 hours ago</p>
                        </div>
                        <span>
